				...
				>
					<div className="movie-container  px-1 sm:px-0">
						...
						<div className="container" onClick={(e: any) => setContainer(e)}>
							...
							<div className="row">
								<div className="flex justify-center items-center seat " title={"45"} id={"45"}><span className="text-[12px] text-white mt-3">45</span></div>
								<div className="flex justify-center items-center seat " title={"46"} id={"46"}><span className="text-[12px] text-white mt-3">46</span></div>
								
								<div className="flex justify-center items-center seat" title={"47"} id={"47"}><span className="text-[12px] text-white mt-3">47</span></div>
								<div className="flex justify-center items-center seat" title={"48"} id={"48"}><span className="text-[12px] text-white mt-3">48</span></div>
								<div className="flex justify-center items-center seat" title={"49"} id={"49"}><span className="text-[12px] text-white mt-3">49</span></div>
							</div>
						</div>
					</div>
				</div>
