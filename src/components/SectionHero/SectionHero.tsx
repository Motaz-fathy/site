	...
	return (
		...
		>
			...
			<div className="container  xl:w-[89%] lg:w-[89%]   xl:translate-y-[-90px] lg:translate-y-[-150px] md:translate-y-[-150px]
			 sm:translate-y-[-150px]   max-sm:translate-y-[-250px]  
			">
			...
			<div
				className="relative z-10 mb-12 xl:translate-y-[-170px] lg:translate-y-[-200px] md:translate-y-[-20px] max-sm:translate-y-[-600px]
