				...
				>
					...
					<div className="flex  flex-col space-y-6 sm:flex-row sm:items-center sm:space-y-0">
						...
						<div className="w-24 flex-shrink-0 lg:w-36">
							...
							{!item?.gateway_id?.includes("WEBUS") && (
								<img src={bus} className="mt-2 w-24" alt="" />
							)}
						</div>
					</div>
				</div>
					...
					<div className="">
						{!item?.gateway_id?.includes("WEBUS") && (
							...
							>
								...
								<div
									className="h-[40px] w-[120px] justify-center p-[8px] align-middle   text-[16px] text-[#69696A]"
									style={{ borderRadius: "24px", textAlign: "center" }}
								>
									{" "}
						...
						{item?.gateway_id?.includes("WEBUS") && (
							...
							>
								...
								/>
								<div
									className="ml-4 h-[40px] w-[120px] justify-center bg-[#E8ECF2] p-[8px] align-middle text-[16px] text-[#69696A] rtl:mr-4
									max-sm:text-[12px]
									sm:text-[12px]
									"
									style={{ borderRadius: "24px", textAlign: "center" }}
