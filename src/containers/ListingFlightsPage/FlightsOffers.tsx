...
export const FlightsOffers = () => {
    ...
    console.log("Flight_Offers" , Flight_Offers)
    ...
    return (
        ...
        <div className='w-full flex justify-start'>
            ...
            <div className='relative'>
                ...
                <span className='text-[#69696A] text-[12px] font-[400]'>{Flight_Offers?.depart_trip?.segments[0]?.durationInMinutes} {t("min")}</span> 
                ...
                <span className='text-[#69696A] text-[12px] font-[400]' >{Flight_Offers?.depart_trip?.segments?.length} {t("stop/s")}</span>
                </div>
            </div>
            ...
            <div className='flex flex-col items-start text-[#69696A] text-[12px] font-[400]'>
                <span className='ml-2'>{t("Baggage included")}:</span>
                <span>1x 23kg</span>
            </div>
            </div>
            </div>
       ...
       <span className='flex justify-start w-full text-[20px] font-[400] text-[#1E1E1E]'>{t("Book your ticket")}</span>
            <span className='flex justify-start w-full text-[#69696A] text-[16px] font-[400] ' >{t("Economy class")}, 1 {t("adult")}</span>
            {
               ...
               <img  src={item?.agent?.imageUrl} alt="image here " />
                ...
                <div className='flex justify-end items-center '>
                    ...
                    <a  href={`${item?.url}`}
                     className='ml-2 cursor-pointer flex justify-center items-center rounded-[10px] text-white btn-hover w-[177px] h-[54px]'>{t("select")}</a>
                </div>
                    </div>
                   )
                })
