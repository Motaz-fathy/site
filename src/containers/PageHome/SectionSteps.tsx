        ...
        <div className="container w-[90%] w-[90%] md:w-[95%] max-md:w-[95%] sm:w-[95%] m-auto flex w-full flex-col items-center justify-center grid grid-cols-4 gap-4 sm:flex-col sm:px-0 max-sm:grid-cols-1">
            ...
            <div className="my-[4px] flex -translate-x-1 items-center justify-between gap-4 rounded-lg border border-gray-100 bg-white  pt-4 sm:pt-12 md:pt-2  lg:p-4">
              <div className="container w-[95%] text-gray-500 sm:pt-2">
                <div className="flex  w-full items-center justify-between max-sm:gap-2">
                  ...
                  >
                    <g clip-path="url(#clip0_2654_2103)">
                      ...
                      />
                      <path
                        d="M9.99994 9.99978H6.80892L7.44792 8.7238C7.57092 8.47681 7.47094 8.17681 7.22391 8.05278C6.97589 7.92978 6.67692 8.02878 6.55289 8.2768L5.55291 10.2768C5.47491 10.4308 5.48391 10.6158 5.57489 10.7628C5.66588 10.9098 5.82689 10.9998 5.99991 10.9998H9.99989C10.2759 10.9998 10.4999 10.7758 10.4999 10.4998C10.4999 10.2238 10.2759 9.99978 9.99994 9.99978Z"
                        fill="black"
                      />
                      <path
                ...
                <div className="flex items-center justify-around py-2">
                  <span className="w-[40%]  text-[12px] text-[#1E1E1E]">
                    {tomorrow}
                  </span>
                  <button
          ...
          <div className="rounded-xl  border-[1px] border-[#FFB229]  ">
            <div className="my-[4px] flex -translate-x-1 items-center justify-between gap-4 rounded-lg border border-gray-100 bg-white  pt-4 sm:pt-12 md:pt-2  lg:p-4">
              <div className="container w-[95%] text-gray-500 sm:pt-2">
                <div className="flex  w-full items-center justify-between max-sm:gap-2">
                  <span className="max-sm:text-[12px] md:text-center ">
                    {t("Dubai")}
                  </span>
              ...
              <div className="my-[4px] flex -translate-x-1 items-center justify-between gap-4 rounded-lg border border-gray-100 bg-white  pt-4 sm:pt-12 md:pt-2  lg:p-4">
                <div className="container w-[95%] text-gray-500 sm:pt-2">
                  ...
                  <div className="flex items-center justify-between py-2">
                    <span className="w-[50%]  text-[12px] text-[#1E1E1E]">
                      {i.date}
                    </span>
                    <button
                      className="btn-hover rounded-xl text-white max-sm:h-[30px] max-sm:w-[60%] md:h-[30px] md:w-[50%]"
                      onClick={() =>
                        handle_to_search(
                          i.date,
                          i.from,
